...
<!--                        </ul>-->
<!--                    </li>-->
                    <?php if ($_SESSION['privileges']->rooms_management == '1') : ?>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <?php if ($_SESSION['privileges']->view_reservations == '1') : ?>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <?php if ($_SESSION['privileges']->users_management == '1') : ?>
                    ...
                    <?php if ($_SESSION['privileges']->messages_management == '1') : ?>
                    ...
                    <?php if ($_SESSION['privileges']->news_management == '1') : ?>
                    ...
                    <?php if ($_SESSION['privileges']->website_settings_management == '1') : ?>
                    ...
                    <?php if ($_SESSION['privileges']->logs == '1') : ?>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Manage Logs</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="<?= HOST_NAME ?>admin/logs">Logs</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>

                    <?php if ($_SESSION['privileges']->testimonials_management == '1') : ?>
                    <li class="menu-item-has-children dropdown">
