        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" name="title" placeholder="Title" class="form-control"><small class="form-text text-muted">Please enter the article's title.</small>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="text" name="place" placeholder="Place" class="form-control"><small class="form-text text-muted">Please enter where the event will take place.</small>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="date" name="date" class="form-control"><small class="form-text text-muted">Please select the date of te event.</small>
                </div>
            </div>
