...
<div class="card">
    <div class="card-header">
        <strong class="card-title">Manage Home About Us #1</strong>
    </div>

    <div class="card-body">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">About Us #1</h4>
            <p><?= $aboutus->content ?></p>
            <hr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scrollmodalLabel">Update Home About Us #1</h5>
