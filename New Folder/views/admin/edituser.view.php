      ...
      <div class="row form-group">
        ...
        <div class="col-12 col-md-9">
          <select name="role" id="select" class="form-control">
            <?php $role_admin = ($user->role == 'admin') ? 'selected' : ''; ?>
            <?php $role_customer = ($user->role == 'customer') ? 'selected' : ''; ?>
            <option <?= $role_admin ?> value="admin">Admin</option>
            <option <?= $role_customer ?> value="customer">Customer</option>
          </select>
        </div>
      </div>
